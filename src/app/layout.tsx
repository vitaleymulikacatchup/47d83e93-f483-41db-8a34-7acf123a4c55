...
export const metadata: Metadata = {
  title: "FitZone - Premium Local Gym & Fitness Center",
  description: "Transform your fitness journey at FitZone. State-of-the-art equipment, expert trainers, group classes, and a supportive community. Join today!",
  keywords: "gym, fitness center, personal training, group classes, weight training, cardio, local gym",
  metadataBase: new URL("https://fitzone.com"),
  alternates: {
    canonical: "https://fitzone.com"
  },
  openGraph: {
    title: "FitZone - Premium Local Gym & Fitness Center",
    description: "Transform your fitness journey at FitZone. State-of-the-art equipment, expert trainers, group classes, and a supportive community.",
    siteName: "FitZone",
    images: [{
